...
```bash
git clone https://github.com/alexbalut/pro-gym-montreal-gym-qr-guide.git
...
Credentials: `admin@pro-gym-montreal.demo` / `demo1234`
...
Seed **wipes** gyms, users, machines, and issues, then recreates Pro Gym Saint-Léonard with 10 machines and sample issues/views.

...
async function main() {
  console.log("Seeding Pro Gym Saint-Léonard...");
  ...
  console.log("   Gym: Pro Gym Saint-Léonard");
  console.log("   Login: admin@pro-gym-montreal.demo / demo1234");
